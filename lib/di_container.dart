...
import 'package:sparsh_user/data/repository/auth_repo.dart';
import 'package:sparsh_user/data/repository/banner_repo.dart';
import 'package:sparsh_user/data/repository/cart_repo.dart';
import 'package:sparsh_user/data/repository/category_repo.dart';
import 'package:sparsh_user/data/repository/chat_repo.dart';
import 'package:sparsh_user/data/repository/coupon_repo.dart';
import 'package:sparsh_user/data/repository/location_repo.dart';
import 'package:sparsh_user/data/repository/news_letter_repo.dart';
import 'package:sparsh_user/data/repository/notification_repo.dart';
import 'package:sparsh_user/data/repository/order_repo.dart';
import 'package:sparsh_user/data/repository/product_repo.dart';
import 'package:sparsh_user/data/repository/language_repo.dart';
import 'package:sparsh_user/data/repository/onboarding_repo.dart';
import 'package:sparsh_user/data/repository/search_repo.dart';
import 'package:sparsh_user/data/repository/profile_repo.dart';
import 'package:sparsh_user/data/repository/splash_repo.dart';
import 'package:sparsh_user/data/repository/wishlist_repo.dart';
import 'package:sparsh_user/provider/auth_provider.dart';
import 'package:sparsh_user/provider/banner_provider.dart';
import 'package:sparsh_user/provider/cart_provider.dart';
import 'package:sparsh_user/provider/category_provider.dart';
import 'package:sparsh_user/provider/chat_provider.dart';
import 'package:sparsh_user/provider/coupon_provider.dart';
import 'package:sparsh_user/provider/localization_provider.dart';
import 'package:sparsh_user/provider/news_provider.dart';
import 'package:sparsh_user/provider/notification_provider.dart';
import 'package:sparsh_user/provider/order_provider.dart';
import 'package:sparsh_user/provider/location_provider.dart';
import 'package:sparsh_user/provider/product_provider.dart';
import 'package:sparsh_user/provider/language_provider.dart';
import 'package:sparsh_user/provider/onboarding_provider.dart';
import 'package:sparsh_user/provider/search_provider.dart';
import 'package:sparsh_user/provider/profile_provider.dart';
