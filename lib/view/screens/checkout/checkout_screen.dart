...
import 'package:sparsh_user/view/screens/checkout/widget/delivery_fee_dialog.dart';
...
import 'package:sparsh_user/data/model/body/place_order_body.dart';
import 'package:sparsh_user/data/model/response/cart_model.dart';
import 'package:sparsh_user/data/model/response/config_model.dart';
...
import 'package:sparsh_user/view/screens/checkout/widget/custom_check_box.dart';
                      ...
                      if(widget.amount < Provider.of<SplashProvider>(context, listen: false).configModel.minimumOrderValue) {
                        ...
                        order.placeOrder(
                          PlaceOrderBody(
                            ...
                            orderAmount: widget.amount+_deliveryCharge, orderNote: _noteController.text+' '+_dateController.text ?? '', orderType: widget.orderType,
      ...
      children: [
        ...
        Padding(
          ...
          child: CustomTextField(
            ...
            hintText: getTranslated('delivery_date', context),
            maxLines: 5,
            inputType: TextInputType.multiline,
            inputAction: TextInputAction.newline,
            capitalization: TextCapitalization.sentences,
  ...
  void _callback(bool isSuccess, String message, String orderID,int addressID) async  {
    ...
    if(true) {
      ...
      if(_isCashOnDeliveryActive && Provider.of<OrderProvider>(context, listen: false).paymentMethodIndex == 0) {
        String ab= '';
        Navigator.pushReplacementNamed(context, '${Routes.ORDER_SUCCESS_SCREEN}/$ab/success');
      }else {
        if (ResponsiveHelper.isWeb()) {
          ...
          // Navigator.pushReplacementNamed(context, Routes.getPaymentRoute('checkout', abc, Provider.of<ProfileProvider>(context, listen: false).userInfoModel.id));
          // Navigator.pushReplacementNamed(context, Routes.getOrderDetailsRoute(int.parse(orderID)));
          Navigator.pushReplacementNamed(context, '${Routes.ORDER_SUCCESS_SCREEN}/$ordermsg/success');
        }
      }
    }else {
