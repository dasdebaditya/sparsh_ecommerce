...
import 'package:sparsh_user/view/screens/checkout/widget/cancel_dialog.dart';
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    ...
    //selectedUrl = '${AppConstants.BASE_URL}/payment-mobile?order_id=${widget.orderModel.id}&&customer_id=${widget.orderModel.userId}';
